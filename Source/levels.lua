...
-- Level 1
levels[1] = {}
levels[1][1] = { 0, 2, 3, 4, 1, 1, 1, 1, 1, 1 }
levels[1][2] = { 0, 1, 0, 0, 0, 1, 1, 1, 1 }
levels[1][3] = { 0, 2, 3, 4, 5, 6, 6, 4, 4 }
levels[1][4] = { 0, 2, 3, 4, 5, 6, 6, 1, 1 }
levels[1][5] = { 0, 1, 0, 0, 0, 1, 1, 0, 0 }
levels[1][6] = { 0, 1, 1, 1, 1, 1, 1, 1, 1 }
levels[1][7] = { 0, 2, 3, 4, 5, 1, 1, 0, 0 }
levels[1][8] = { 0, 1, 0, 0, 0, 1, 1, 0, 0 }
levels[1][9] = { 0, 1, 1, 1, 1, 1, 1, 0, 0 }
