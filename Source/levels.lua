...
-- Level 2
levels[3] = {}
levels[3][1] = { 1, 2, 3, 4, 1, 1, 1, 1, 1 }
levels[3][2] = { 1, 1, 0, 0, 0, 1, 1, 1, 1 }
levels[3][3] = { 1, 2, 3, 4, 5, 6, 6, 4, 4 }
levels[3][4] = { 1, 2, 3, 4, 5, 6, 6, 1, 1 }
levels[3][5] = { 1, 1, 0, 0, 0, 1, 1, 0, 0 }
levels[3][6] = { 1, 1, 1, 1, 1, 1, 1, 1, 1 }
levels[3][7] = { 1, 2, 3, 4, 5, 1, 1, 0, 0 }
levels[3][8] = { 1, 1, 0, 0, 0, 1, 1, 0, 0 }
levels[3][9] = { 1, 1, 1, 1, 1, 1, 1, 0, 0 }
levels[3][10] = { 1, 2, 3, 4, 5, 1, 1, 1, 1 }

-- Level 3
levels[4] = {}
levels[4][1] = { 0, 0, 3, 4, 1, 1, 1, 1, 1, 1 }
levels[4][2] = { 0, 0, 0, 0, 0, 1, 1, 1, 1 }
levels[4][3] = { 0, "-", 3, 4, 5, 6, 6, 4, 4 }
levels[4][4] = { 0, "-", 3, 4, 5, 6, 6, 1, 1 }
levels[4][5] = { 0, "-", 0, 0, 0, 1, 1, 0, 0 }
levels[4][6] = { 0, "-", 1, 1, 1, 1, 1, 1, 1 }
levels[4][7] = { 0, "-", 1, 1, 1, 1, 1, 1, 1 }
levels[4][8] = { 0, "-", 1, 1, 1, 1, 1, 1, 1 }
levels[4][9] = { 0, "-", 1, 1, 1, 1, 1, 1, 1 }
levels[4][10] = { 0, "-", "-", "-", "-", "-", "-", "-", "-", "-" }
